    ...
    <div class="content-card__inner">
      ...
      <div class="content-card__body">
        <div class="form-group">
          <div class="form-item">
            <label for="" class="form-item__label">Загрузите от 1 до 6 фотографий*</label>

            <div class="form-file">
              <div class="form-file__inner">

                <label class="form-file__card form-file__upload-button" for="imageUpload">
                  <input class="form-file__upload-input" type="file" id="imageUpload" accept="images/*" multiple>
